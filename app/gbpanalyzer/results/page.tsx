...
function ResultsContent() {
    ...
    return (
      <div className="min-h-[60vh] flex items-center justify-center">
        <div className="text-center">
          <svg className="animate-spin w-8 h-8 text-brand-red mx-auto" viewBox="0 0 24 24" fill="none">
    ...
    return (
      <div className="min-h-[60vh] flex items-center justify-center">
        <div className="text-center max-w-md mx-auto px-4">
          ...
          <h2 className="mt-4 text-xl font-bold text-white">{error || "Something went wrong"}</h2>
          <Link
            href="/gbpanalyzer"
            className="mt-6 inline-flex items-center px-8 py-4 bg-brand-red text-white font-bold rounded-full hover:bg-brand-red-dark transition-all hover:shadow-[0_0_25px_rgba(185,28,28,0.5)] text-sm uppercase tracking-wider"
          >
            Run New Analysis
          </Link>
        </div>
  ...
  return (
    <>
      {/* Score Header */}
      <section className="relative bg-gradient-to-b from-black via-gray-900/95 to-black py-16 md:py-24 overflow-hidden">
        <StarsBackground />
      ...
      <section className="bg-brand-dark py-16 md:py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <h2 className="text-2xl md:text-3xl font-extrabold text-white font-[family-name:var(--font-heading)] mb-10">
            Score Breakdown
          </h2>
      ...
      {analysis.topSuggestions.length > 0 && (
        <section className="relative bg-gradient-to-b from-black via-gray-900/95 to-black py-16 md:py-24 overflow-hidden">
          ...
          <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6">
            <h2 className="text-2xl md:text-3xl font-extrabold text-white font-[family-name:var(--font-heading)] mb-8">
              Your Top Priorities
            </h2>
            <div className="space-y-4">
              {analysis.topSuggestions.map((suggestion, i) => (
                <div key={i} className="flex items-start gap-4 bg-gray-900 border border-gray-800 rounded-xl p-5 hover:border-gray-700 transition-colors">
                  <div className="w-8 h-8 rounded-full bg-brand-red text-white flex items-center justify-center text-sm font-bold shrink-0">
                    {i + 1}
                  </div>
                  <p className="text-sm text-gray-300 leading-relaxed pt-1">{suggestion}</p>
                </div>
              ))}
            </div>
          </div>
      ...
      <section className="relative py-20 md:py-28 overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto px-4 sm:px-6 text-center">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-extrabold text-white leading-tight font-[family-name:var(--font-heading)]">
            Let Us Walk Through Your Results
          </h2>
          <p className="mt-6 text-gray-300 text-lg leading-relaxed">
            Numbers only tell part of the story. Book a free call with our team and we&apos;ll break down your score, explain what to fix first, and build an action plan together.
          </p>
          <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/contact"
              className="inline-flex items-center justify-center px-10 py-4 bg-brand-red text-white font-bold rounded-full hover:bg-brand-red-dark transition-all text-sm uppercase tracking-wider hover:shadow-[0_0_25px_rgba(185,28,28,0.5)]"
            >
            ...
            <Link
              href="/gbpanalyzer"
              className="inline-flex items-center justify-center px-10 py-4 bg-white/10 text-white font-bold rounded-full hover:bg-white/20 transition-all border border-white/20 text-sm uppercase tracking-wider"
            >

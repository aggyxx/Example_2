      ...
      <section className="bg-gradient-to-br from-brand-navy via-brand-blue to-brand-navy py-16 md:py-24 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-6 text-lg text-gray-300 max-w-2xl mx-auto">
            Ready to take the next step? Fill out the form below and our team will get back to you within 24 hours.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-5 gap-16">
            ...
            <div className="md:col-span-3">
              <h2 className="text-2xl font-bold text-brand-charcoal font-[family-name:var(--font-heading)]">
                Send Us a Message
              </h2>
              ...
              <form onSubmit={handleSubmit} className="mt-8 space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 rounded-lg border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-brand-blue/20 focus:border-brand-blue transition-colors resize-none"
                ...
                <button
                  ...
                  className="w-full md:w-auto px-8 py-4 bg-brand-red text-white font-semibold rounded-lg hover:bg-brand-red-dark transition-all shadow-lg shadow-red-900/20 disabled:opacity-50 disabled:cursor-not-allowed"
                >
            ...
            <div className="md:col-span-2">
              <div className="bg-brand-gray rounded-xl p-8">
                <h3 className="text-lg font-bold text-brand-charcoal">Other Ways to Reach Us</h3>
                ...
                <div className="mt-6 space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <div className="text-sm font-medium text-brand-charcoal">Email</div>
                      <a href="mailto:info@schoolofhomeservice.com" className="text-sm text-brand-blue hover:text-brand-red transition-colors">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <div className="text-sm font-medium text-brand-charcoal">Location</div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <div className="text-sm font-medium text-brand-charcoal">Response Time</div>
                ...
                <div className="mt-8 pt-6 border-t border-gray-200">
                  <h4 className="text-sm font-semibold text-brand-charcoal mb-4">Follow Us</h4>
                  <div className="flex gap-3">
                    {[
                      ...
                      <a
                        ...
                        href="#"
                        aria-label={s.label}
                        className="w-10 h-10 rounded-lg bg-white text-gray-500 hover:text-brand-blue flex items-center justify-center transition-colors border border-gray-100"
                      >
